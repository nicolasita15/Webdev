...
<body>
    ...
    <!-- new arrivals-->
    <section id = "arrivals" class = "py-5">
        <div class = "container">
            ...
            <div class = "row g-0">
                <div class = "d-flex flex-wrap justify-content-center mt-5 filter-button-group">
                    ...
                    <button type = "button" class = "btn m-2 text-dark active-filter-btn" data-filter = "*">New Arrival</button>
                </div>

                <div class = "arrivals-list mt-4 row gx-0 gy-3">
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 best">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt46.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Off High La Blanca Shirt</p>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 feat">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt47.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Off High Pick Up Girl Shirt</p>
                            <span class = "fw-bold">Php 600</span><br> 
                            <a href = "#" class = "btn btn-primary mt-3">Add to Cart</a>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 new">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt48.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">7th king Magician Shirt</p>
                            <span class = "fw-bold">Php 600</span><br>
                            <a href = "#" class = "btn btn-primary mt-3">Add to Cart</a>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 best">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt49.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Daily Grind Bloat Shirt</p>
                            <span class = "fw-bold">Php 600</span><br>
                            <a href = "#" class = "btn btn-primary mt-3">Add to Cart</a>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 feat">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt50.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Daily Grind Long Last Shirt</p>
                            <span class = "fw-bold">Php 600</span><br>
                            <a href = "#" class = "btn btn-primary mt-3">Add to Cart</a>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-4 p-2 new">
                        <div class = "arrivals-img position-relative">
                            <img src = "shirt51.png" class = "w-100">
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">7th King Calvera Shirt</p>
                            <span class = "fw-bold">Php 600</span><br>
                            <a href = "#" class = "btn btn-primary mt-3">Add to Cart</a>
                        </div>
                    </div>
